 ...
 * 2.클라이언트의 접속을 기다리고 있다가 접속해 오면 이를 받아들임
 * 3.반환된 socket 객체는 클라이언트와 통신을 하고
 * serversocket 객체는 다시 다른 클라이언트의 접속을 기다림
 * 4.클라이언트와 접속을 종료 하려면 socket 객체를 닫아준다.
 
 서버소켓에서 반응해서 클라이언트 소켓만큼 소켓이 쌓인다.
 * */
